...
public class Weapon : Item
{
    ...
    private bool MakeShoot()
    {
        ...
        Rigidbody bullet = Instantiate(bulletPrefab, spawnPoint.position, spawnPoint.rotation) as Rigidbody;
        bullet.velocity = spawnPoint.TransformDirection(new Vector3(0, 0, bulletSpeed));
        bulletCounts--;
